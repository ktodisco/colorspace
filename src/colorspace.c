...
color_matrix_t FUNDAMENTALS_SMITH_POKORNY = _FUNDAMENTALS_SMITH_POKORNY;
color_matrix_t FUNDAMENTALS_HPE_D65 = _FUNDAMENTALS_HPE_D65;
color_matrix_t FUNDAMENTALS_STOCKMAN_SHARPE = _FUNDAMENTALS_STOCKMAN_SHARPE;
...
color_matrix_t make_xyz_conversion(const colorspace_t* colorspace)
{
	...
	color_matrix_t m_inv = color_matrix_invert(&m);
...
{
	color_matrix_t a_to_xyz = make_xyz_conversion(colorspace_a);
	color_matrix_t b_to_xyz = make_xyz_conversion(colorspace_b);

	color_matrix_t xyz_to_b = color_matrix_invert(&b_to_xyz);

	return color_matrix_multiply(&xyz_to_b, &a_to_xyz);
}

color_vec_t _get_alpha_beta_gamma(const colorspace_t* colorspace)
{
	const color_matrix_t convert_xyz_to_lms = {
