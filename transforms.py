...
if __name__ == "__main__":
    ...
    RGB_to_XYZ = compute_XYZ_conversion(COLORSPACE_HDR)
    print(RGB_to_XYZ)
    print("")
    ...
    protanope, deuteranope, tritanope = compute_daltonization_transforms(COLORSPACE_HDR)
    print(protanope)
    print("")
    print(deuteranope)
    print("")
    ...
    print(xyY_to_XYZ(xyY(0.15, 0.06, 0.0722)).data)